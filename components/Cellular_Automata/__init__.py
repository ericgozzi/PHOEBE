...
class MyComponent(Grasshopper.Kernel.GH_ScriptInstance):
    def RunScript(self,
            ...
            cell_height,
            alive_scheme: Grasshopper.DataTree[object],
            blueprint,
        ...
        if chunks.BranchCount == 0:
            ghenv.Component.Message = "Please provide chunks"
            return
        elif alive_scheme.BranchCount == 0:
            ghenv.Component.Message = "Please provide alive alive scheme"
            return
        elif blueprint == None:
            ghenv.Component.Message = "Please provide blueprint"
            return

        if  not run_cellular_automata:
            ghenv.Component.Message = "All set up: let's evolve!" 
        else:
            ghenv.Component.Message = "Evolved"       
        ...
        organism = Organism(max_generations, blueprint, chunks)
        
        # The first breath is taken, the beginning of all things.
        alive_scheme = th.tree_to_list(alive_scheme)
